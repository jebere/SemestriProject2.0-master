...
namespace SemestriProject.Tests.Facade.Common
{
    ...
    public class OrderEntityViewTests : AbstractClassTests<OrderEntityView, UniqueEntityView>
    {
        ...
        {
            isNullableProperty(() => obj.DangerousGoods, x => obj.DangerousGoods = x);
        }
        [TestMethod]
        public void TemperatureSensitiveTest()
        {
            isNullableProperty(() => obj.TemperatureSensitive, x => obj.TemperatureSensitive = x);
        }
        [TestMethod]
        ...
        {
            isNullableProperty(() => obj.AcceptTerms, x => obj.AcceptTerms = x);
        }
